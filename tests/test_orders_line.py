...
class TestOrdersLine:
    ...
    def test_popup_order(self, driver):
        ...
        # Assert
        assert orders_line_page.wait_for_element(OrdersLineLocators.ORDER_POPUP_SCREEN)
    ...
    def test_orders_history_and_line(self, login):
        ...
        order_in_line = orders_line_page.get_text_on_element(OrdersLineLocators.ORDER)
        # Assert
